.PHONY: clean requirements data lint features visualize train predict run run_container sync_data_to_s3 sync_data_from_s3
...
PROFILE = default
PROJECT_NAME = housing_prices_firenze
